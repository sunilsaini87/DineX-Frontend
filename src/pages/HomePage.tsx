  ...
  return (
    <div className="flex flex-col gap-12  ">
      ...
      <div className="container mx-auto px-6 text-center ">
        <h2 className="text-xl font-semibold text-red-600 mb-2">Why Choose DineX?</h2>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center space-y-6 md:space-y-0 md:space-x-8">
          <div className="bg-red-50 p-6 rounded-lg shadow-lg w-full md:w-1/2 text-left">
            <h3 className="text-xl font-bold text-red-600 mb-4">Premium Membership</h3>
          ...
          <div className="bg-red-100 p-6 rounded-lg shadow-lg w-full md:w-1/4 text-center">
            ...
            <button className="bg-red-600 text-white py-2 px-4 rounded-lg shadow-lg">Join Now</button>
